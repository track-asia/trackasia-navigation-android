...
class OffRouteDetectorTest : BaseTest() {
    ...
    private val defaultOptions = TrackAsiaNavigationOptions()
    ...
    fun validOffRoute_onMinimumDistanceBeforeReroutingPassed() {
        ...
        val trackAsiaNavigationOptions = TrackAsiaNavigationOptions()
        ...
        val target = buildPointAwayFromLocation(
            mapboxOffice,
            trackAsiaNavigationOptions.offRouteMinimumDistanceMetersBeforeWrongDirection + 1
        )
