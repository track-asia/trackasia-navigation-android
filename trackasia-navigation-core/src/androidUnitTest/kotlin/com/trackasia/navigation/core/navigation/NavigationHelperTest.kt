...
import com.trackasia.navigation.core.milestone.Trigger.eq
...
import com.trackasia.navigation.core.models.LegAnnotation
...
import com.trackasia.navigation.core.navigation.NavigationHelper.nextManeuverPosition
...
class NavigationHelperTest : BaseTest() {
    ...
    fun checkMilestones_onlyTriggeredMilestonesGetReturned() {
        ...
        val trackAsiaNavigation = TrackAsiaNavigation(options, locationEngine = mockk())
    ...
    fun offRouteDetectionDisabled_isOffRouteReturnsFalse() {
        ...
        val trackAsiaNavigation = TrackAsiaNavigation(options = options, locationEngine = mockk())

        val userOffRoute = isUserOffRoute(trackAsiaNavigation, mockk(), mockk(), mockk())
