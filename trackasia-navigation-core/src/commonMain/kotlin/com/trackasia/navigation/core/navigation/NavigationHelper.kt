...
object NavigationHelper {
     ...
     *
     * @param trackAsiaNavigation current running navigation instance
    ...
    fun isUserOffRoute(
        ...
        val options = trackAsiaNavigation.options
        if (!options.enableOffRouteDetection) {
            return false
        }

        val offRouteEngine = trackAsiaNavigation.offRouteEngine
