...
import com.trackasia.navigation.core.models.MaxSpeed
...
data class CurrentLegAnnotation(
     ...
     * [com.trackasia.navigation.core.models].
     *
     * @since 0.13.0
     */
    val index: Int,
    ...
    /**
     * Distance along the [com.trackasia.navigation.core.models.RouteLeg] that adds
