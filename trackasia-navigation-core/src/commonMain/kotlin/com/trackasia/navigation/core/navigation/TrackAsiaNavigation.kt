...
import com.trackasia.navigation.core.navigation.NavigationConstants.BANNER_INSTRUCTION_MILESTONE_ID
import com.trackasia.navigation.core.navigation.NavigationConstants.VOICE_INSTRUCTION_MILESTONE_ID
...
import com.trackasia.navigation.core.navigation.engine.TrackAsiaNavigationEngine
import com.trackasia.navigation.core.navigation.engine.NavigationEngine
...
import com.trackasia.navigation.core.utils.ValidationUtils
...
open class TrackAsiaNavigation @JvmOverloads constructor(
    ...
    private var trackAsiaNavigationEngine: NavigationEngine? = null
        set(value) {
    ...
    fun startNavigation(directionsRoute: DirectionsRoute) {
        ...
        Logger.d { "TrackAsiaNavigation startNavigation called." }
     ...
     */
    fun stopNavigation() {
        Logger.d { "TrackAsiaNavigation stopNavigation called" }
     ...
     * `this` TrackAsiaNavigation instance by the constructor. This would cause memory leaks.
    ...
    private fun getNavigationEngineInternal(): NavigationEngine {
        if (trackAsiaNavigationEngine == null) {
            trackAsiaNavigationEngine = TrackAsiaNavigationEngine(
                trackAsiaNavigation = this,
                routeUtils = routeUtils,
                backgroundScope = CoroutineScope(Dispatchers.Default + navigationRunnerJob)
            )
        }

        return trackAsiaNavigationEngine!!
