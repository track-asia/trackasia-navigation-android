...
class TimeFormatterTest {
    ...
    fun checksTwelveHoursTimeFormat() {
        ...
        val twelveHoursTimeFormatType = TrackAsiaNavigationOptions.TimeFormat.TWELVE_HOURS
    ...
    fun checksTwentyFourHoursTimeFormat() {
        ...
        time[anyYear, anyMonth, anyDay, sixPm, eighteenMinutes] = zeroSeconds
        val elevenMinutes = 663.7
        val twentyFourHoursTimeFormatType = TrackAsiaNavigationOptions.TimeFormat.TWENTY_FOUR_HOURS
    ...
    fun checksDefaultTwelveHoursTimeFormat() {
        ...
        time[anyYear, anyMonth, anyDay, sixPm, eighteenMinutes] = zeroSeconds
        val elevenMinutes = 663.7
        val noneSpecifiedTimeFormatType = TrackAsiaNavigationOptions.TimeFormat.NONE_SPECIFIED
