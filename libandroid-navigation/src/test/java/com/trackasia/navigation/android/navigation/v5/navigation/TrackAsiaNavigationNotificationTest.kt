...
class TrackAsiaNavigationNotificationTest : BaseTest() {
    ...
    @Throws(Exception::class)
    fun sanity() {
        val trackAsiaNavigationNotification = TrackAsiaNavigationNotification(mockk(), mockk())
        Assert.assertNotNull(trackAsiaNavigationNotification)
    }
    ...
    fun updateDefaultNotification_onlyUpdatesNameWhenNew() {
        ...
        trackAsiaNavigationNotification.updateNotification(routeProgress)
