...
import com.trackasia.navigation.android.navigation.v5.milestone.StepMilestone
import com.trackasia.navigation.android.navigation.v5.milestone.Trigger.eq
import com.trackasia.navigation.android.navigation.v5.milestone.TriggerProperty
...
import com.trackasia.navigation.android.navigation.v5.models.LegAnnotation
...
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationHelper.createCurrentAnnotation
...
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationHelper.increaseIndex
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationHelper.isUserOffRoute
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationHelper.nextManeuverPosition
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationHelper.stepDistanceRemaining
import com.trackasia.navigation.android.navigation.v5.routeprogress.CurrentLegAnnotation
...
class NavigationHelperTest : BaseTest() {
    ...
    fun checkMilestones_onlyTriggeredMilestonesGetReturned() {
        val routeProgress = buildMultiLegRouteProgress()
        val options = TrackAsiaNavigationOptions(defaultMilestonesEnabled = false)
        val context = mockk<Context>(relaxed = true) {
            every { applicationContext } returns this
        }
        val trackAsiaNavigation = TrackAsiaNavigation(context, options, mockk())
        trackAsiaNavigation.addMilestone(
        ...
        val triggeredMilestones = checkMilestones(
            routeProgress,
            routeProgress, trackAsiaNavigation
        )
    ...
    fun offRouteDetectionDisabled_isOffRouteReturnsFalse() {
        val options = TrackAsiaNavigationOptions(enableOffRouteDetection = false)
        val context = mockk<Context>(relaxed = true) {
            every { applicationContext } returns this
        }
        val trackAsiaNavigation = TrackAsiaNavigation(context, options, mockk())
        val model = NavigationLocationUpdate(mockk(), trackAsiaNavigation)
