package com.trackasia.navigation.android.navigation.v5.routeprogress

import com.trackasia.navigation.android.navigation.v5.models.MaxSpeed
...
data class CurrentLegAnnotation(
     ...
     * [com.trackasia.navigation.android.navigation.v5.models].
     *
     * @since 0.13.0
     */
    val index: Int,
    ...
    /**
     * Distance along the [com.trackasia.navigation.android.navigation.v5.models.RouteLeg] that adds
