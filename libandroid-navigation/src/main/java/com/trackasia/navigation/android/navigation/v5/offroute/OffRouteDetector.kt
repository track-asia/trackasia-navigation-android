...
import com.trackasia.navigation.android.navigation.v5.utils.MeasurementUtils.userTrueDistanceFromStep
import com.trackasia.navigation.android.navigation.v5.utils.RingBuffer
import com.trackasia.navigation.android.navigation.v5.utils.ToleranceUtils.dynamicOffRouteRadiusTolerance
...
open class OffRouteDetector(
     ...
     * the [TrackAsiaNavigationOptions.offRouteMinimumDistanceMetersAfterReroute] checked against the last re-route location.
     *
     *
     * Test #3:
     ...
     * But, if the location update is within the [TrackAsiaNavigationOptions.maneuverZoneRadius] of the
    ...
    override fun isUserOffRoute(
        ...
        options: TrackAsiaNavigationOptions
    ): Boolean {
    ...
    /**
     * Method to check if the user has passed either the set (in [TrackAsiaNavigationOptions.offRouteMinimumDistanceMetersAfterReroute])
     ...
     */
    private fun validOffRoute(location: Location, options: TrackAsiaNavigationOptions): Boolean {
