...
interface OffRouteCallback {
     ...
     * location is close enough to the upcoming [com.trackasia.navigation.android.navigation.v5.models.LegStep].
     *
    ...
    /**
     * This callback will fire when the [OffRouteDetector] determines that the user
     * location is close enough to a [com.trackasia.navigation.android.navigation.v5.models.LegStep].
     *
