package com.trackasia.navigation.android.navigation.v5.navigation.notification
...
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationService

/**
 * Defines a contract in which a custom notification must adhere to when
 * given to [TrackAsiaNavigationOptions].
 */
interface NavigationNotification {
    ...
    /**
     * Callback for when navigation is stopped via [TrackAsiaNavigation.stopNavigation].
     *
     *
    ...
    companion object {
        const val END_NAVIGATION_ACTION: String =
            "com.trackasia.navigation.android.intent.action.END_NAVIGATION"
        const val OPEN_NAVIGATION_ACTION: String =
            "com.trackasia.navigation.android.intent.action.OPEN_NAVIGATION"
    }
}
