...
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationConstants.BANNER_INSTRUCTION_MILESTONE_ID
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationConstants.VOICE_INSTRUCTION_MILESTONE_ID
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationService.LocalBinder
...
import com.trackasia.navigation.android.navigation.v5.offroute.OffRoute
import com.trackasia.navigation.android.navigation.v5.offroute.OffRouteDetector
...
import com.trackasia.navigation.android.navigation.v5.snap.Snap
...
import com.trackasia.navigation.android.navigation.v5.utils.ValidationUtils
import timber.log.Timber

/**
 * A TrackAsiaNavigation class for interacting with and customizing a navigation session.
 *
 * Instance of this class are used to setup, customize, start, and end a navigation session.
 * Building a custom
 * [TrackAsiaNavigationOptions] object and passing it in allows you to further customize the
 ...
 * @param options               a custom built `TrackAsiaNavigationOptions` class
 ...
 *
 * @see TrackAsiaNavigationOptions
 */
open class TrackAsiaNavigation @JvmOverloads constructor(
    private val applicationContext: Context,
    val options: TrackAsiaNavigationOptions = TrackAsiaNavigationOptions(),
    /**
     ...
     * [TrackAsiaNavigationOptions.defaultMilestonesEnabled] is set to false but they can also
    ...
    fun startNavigation(directionsRoute: DirectionsRoute) {
        ...
        Timber.d("TrackAsiaNavigation startNavigation called.")
     ...
     * user arrives unless you set [TrackAsiaNavigationOptions.manuallyEndNavigationUponCompletion]
     * to true.
     *
     *
     ...
     * route and the specified criteria's in [TrackAsiaNavigationOptions] have been met.
     *
     *
    ...
    override fun onServiceConnected(name: ComponentName, service: IBinder) {
        ...
        (service as LocalBinder).service?.let { navigationService ->
            ...
            this@TrackAsiaNavigation.navigationService = navigationService
