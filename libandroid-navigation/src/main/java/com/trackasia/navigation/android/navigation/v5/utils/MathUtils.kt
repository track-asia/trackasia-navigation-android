...
import com.trackasia.android.utils.MathUtils as TrackAsiaMathUtils
...
object MathUtils {
    ...
    fun clamp(value: Double, min: Double, max: Double): Double {
        return TrackAsiaMathUtils.clamp(value, min, max)
    }
    ...
    fun wrap(value: Double, min: Double, max: Double): Double {
        return TrackAsiaMathUtils.wrap(value, min, max)
    }
