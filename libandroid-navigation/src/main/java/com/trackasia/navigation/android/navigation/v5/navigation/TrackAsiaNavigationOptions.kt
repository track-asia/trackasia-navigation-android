...
import com.trackasia.navigation.android.navigation.v5.navigation.NavigationConstants.RoundingIncrement
...
/**
 * Immutable and can't be changed after passing into [TrackAsiaNavigation].
 */
data class TrackAsiaNavigationOptions(
    /**
     ...
     * for a faster [com.trackasia.navigation.android.navigation.v5.models.DirectionsRoute].
     */
    ...
    class Builder {
        ...
        fun build(): TrackAsiaNavigationOptions {
            return TrackAsiaNavigationOptions(
