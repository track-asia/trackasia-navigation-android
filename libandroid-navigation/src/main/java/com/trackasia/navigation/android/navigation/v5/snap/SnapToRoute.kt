...
import com.trackasia.navigation.android.navigation.v5.utils.MathUtils.wrap
 ...
 * uses the TrackAsia Map SDK, querying the map and snapping the user to the road grid might be a
 * better solution.
 *
 * @since 0.4.0
 */
