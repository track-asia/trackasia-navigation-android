...
open class RouteProcessorBackgroundThread(
...
) : HandlerThread(TRACKASIA_NAVIGATION_THREAD_NAME, Process.THREAD_PRIORITY_BACKGROUND) {
    ...
    companion object {
        private const val TRACKASIA_NAVIGATION_THREAD_NAME = "trackasia_navigation_thread"
