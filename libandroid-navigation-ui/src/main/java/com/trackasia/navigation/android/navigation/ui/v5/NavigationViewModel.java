...
import com.trackasia.navigation.android.navigation.ui.v5.summary.SummaryModel;
import com.trackasia.navigation.android.navigation.ui.v5.voice.NavigationSpeechPlayer;
...
public class NavigationViewModel extends AndroidViewModel {
    ...
    private TrackAsiaNavigationOptions.TimeFormat timeFormatType;
    ...
    NavigationViewModel(Application application, TrackAsiaNavigation navigation,
    ...
    /**
     * Returns the current instance of {@link TrackAsiaNavigation}.
     * <p>
     * Will be null if navigation has not been initialized.
     */
    @Nullable
    public TrackAsiaNavigation retrieveNavigation() {
        return navigation;
    }
    ...
    /**
     * This method will pass {@link TrackAsiaNavigationOptions} from the {@link NavigationViewOptions}
     * to this view model to be used to initialize {@link TrackAsiaNavigation}.
     *
    ...
    private void initializeRouter() {
        TrackAsiaRouteFetcher onlineRouter = new TrackAsiaRouteFetcher(getApplication());
    ...
    private void initializeTimeFormat(TrackAsiaNavigationOptions options) {
