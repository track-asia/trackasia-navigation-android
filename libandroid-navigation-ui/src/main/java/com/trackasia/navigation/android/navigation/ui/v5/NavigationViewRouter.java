...
public class NavigationViewRouter implements RouteListener {
  ...
  private final TrackAsiaRouteFetcher onlineRouter;
  ...
  public NavigationViewRouter(TrackAsiaRouteFetcher onlineRouter, ConnectivityStatusProvider connectivityStatus,
  ...
  NavigationViewRouter(TrackAsiaRouteFetcher onlineRouter,
