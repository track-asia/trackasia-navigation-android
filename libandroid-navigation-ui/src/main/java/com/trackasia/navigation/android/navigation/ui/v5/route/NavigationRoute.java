 ...
 * {@link TrackAsiaNavigation#startNavigation(DirectionsRoute)}, using this class will ensure your
...
public final class NavigationRoute {
    ...
    private Callback<com.mapbox.api.directions.v5.models.DirectionsResponse> toMapboxCallback(Callback<DirectionsResponse> callback) {
        return new Callback<>() {
            ...
            public void onResponse(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call, Response<com.mapbox.api.directions.v5.models.DirectionsResponse> response) {
                callback.onResponse(toTrackAsiaCall(call), toTrackAsiaResponse(response));
            }

            @Override
            public void onFailure(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call, Throwable t) {
                callback.onFailure(toTrackAsiaCall(call), t);
            }
        };
    }

    private Response<DirectionsResponse> toTrackAsiaResponse(Response<com.mapbox.api.directions.v5.models.DirectionsResponse> response) {
        if (response.isSuccessful()) {
            return Response.success(response.code(), toTrackAsiaDirectionsResponse(response.body()));
        } else {
            return Response.error(response.errorBody(), response.raw());
        }
    }

    private Call<DirectionsResponse> toTrackAsiaCall(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call) {
        return new Call<>() {
            @Override
            public Response<DirectionsResponse> execute() throws IOException {
                return toTrackAsiaResponse(call.execute());
            }
            ...
            public Call<DirectionsResponse> clone() {
                return toTrackAsiaCall(call.clone());
            }
    ...
    public Call<DirectionsResponse> getCall() {
        return toTrackAsiaCall(mapboxDirections.cloneCall());
    }
    ...
    public static final class Builder {
         ...
         *
         * @param origin a GeoJson {@link com.trackasia.geojson.Point} object representing the starting location for the route
         * @return this builder for chaining options together
         * @since 0.5.0
         */
        public Builder origin(@NonNull com.trackasia.geojson.Point origin) {
         ...
         * required parameters which must be set for a successful directions response.
         *
         * @param origin    a GeoJson {@link com.trackasia.geojson.Point} object representing the starting location for the
         *                  route
         ...
         * @since 0.5.0
         */
        public Builder origin(@NonNull com.trackasia.geojson.Point origin, @Nullable Double angle,
         ...
         *
         * @param destination a GeoJson {@link com.trackasia.geojson.Point} object representing the starting location for the
         *                    route
         * @return this builder for chaining options together
         * @since 0.50
         */
        public Builder destination(@NonNull com.trackasia.geojson.Point destination) {
         ...
         * @since 0.5.0
         */
        public Builder destination(@NonNull com.trackasia.geojson.Point destination, @Nullable Double angle,
                                   @Nullable Double tolerance) {
         ...
         *
         * @param waypoint a {@link com.trackasia.geojson.Point} which represents the pit-stop or waypoint where you'd like
         *                 one of the {@link com.trackasia.navigation.android.navigation.v5.models.RouteLeg} to
         *                 navigate the user to
         * @return this builder for chaining options together
         * @since 0.5.0
         */
        public Builder addWaypoint(@NonNull com.trackasia.geojson.Point waypoint) {
         ...
         * @since 0.5.0
         */
        public Builder addWaypoint(@NonNull com.trackasia.geojson.Point waypoint, @Nullable Double angle,
                                   @Nullable Double tolerance) {
            directionsBuilder.addWaypoint(toMapboxPoint(waypoint));
            directionsBuilder.addBearing(angle, tolerance);
            return this;
         ...
         *                    restricted to one or multiple values inside the {@link com.trackasia.navigation.android.navigation.v5.models.DirectionsCriteria.AnnotationCriteria}
         ...
         * other fields outside of the {@link com.trackasia.navigation.android.navigation.v5.models.VoiceInstructions}
         * object.
         *
         * @param voiceUnits one of the values found inside the {@link com.trackasia.navigation.android.navigation.v5.models.DirectionsCriteria.VoiceUnitCriteria}
         * @return this builder for chaining options together
         * @since 0.8.0
         */
    ...
    private static DirectionsResponse toTrackAsiaDirectionsResponse(com.mapbox.api.directions.v5.models.DirectionsResponse directionsResponse) {
    ...
    private static com.mapbox.geojson.Point toMapboxPoint(com.trackasia.geojson.Point point) {
