...
class RouteConstants {
  static final String TRACKASIA_LOCATION_ID = "mapbox-location";
  ...
  static final String LAYER_ABOVE_UPCOMING_MANEUVER_ARROW = TrackAsiaConstants.LAYER_ID_ANNOTATIONS;
