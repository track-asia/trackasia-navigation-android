...
import com.trackasia.navigation.android.navigation.ui.v5.instruction.ImageCreator;
import com.trackasia.navigation.android.navigation.ui.v5.instruction.NavigationAlertView;
import com.trackasia.navigation.android.navigation.ui.v5.map.NavigationTrackAsiaMap;
...
public class NavigationView extends CoordinatorLayout implements LifecycleOwner, OnMapReadyCallback,
   ...
   *
   * @param trackAsiaMap used for route, camera, and location UI
   * @since 0.6.0
   */
  @Override
  public void onMapReady(final TrackAsiaMap trackAsiaMap) {
    trackAsiaMap.setStyle(ThemeSwitcher.retrieveMapStyle(getContext()), new Style.OnStyleLoaded() {
      @Override
      public void onStyleLoaded(@NonNull Style style) {
        initializeNavigationMap(mapView, trackAsiaMap);
   ...
   *
   * @return navigation TrackAsia map object, or null if view has not been initialized
   */
  @Nullable
  ...
  /**
   * Returns the instance of {@link TrackAsiaNavigation} powering the {@link NavigationView}
   ...
   *
   * @return TrackAsia navigation, or null if navigation has not started
   */
  @Nullable
  public TrackAsiaNavigation retrieveTrackAsiaNavigation() {
