...
public abstract class NavigationViewOptions extends NavigationUiOptions {
  ...
  public abstract TrackAsiaNavigationOptions navigationOptions();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder navigationOptions(TrackAsiaNavigationOptions navigationOptions);
  ...
  public static Builder builder() {
    return new AutoValue_NavigationViewOptions.Builder()
      .navigationOptions(new TrackAsiaNavigationOptions())
