package com.trackasia.navigation.android.navigation.ui.v5.notification
...
open class TrackAsiaNavigationNotification(
    ...
    private val distanceFormatter: DistanceFormatter = initializeDistanceFormatter(context, trackAsiaNavigation)
    ...
    private val endNavigationBtnReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            this@TrackAsiaNavigationNotification.onEndNavigationBtnClick()
        }
    }
    ...
    private fun initializeDistanceFormatter(
        ...
        val routeOptions = trackAsiaNavigation.route?.routeOptions
        ...
        return DistanceFormatter(
            ...
            language,
            unitType,
            trackAsiaNavigation.options.roundingIncrement
        )
    }
