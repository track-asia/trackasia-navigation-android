...
import com.trackasia.navigation.android.navigation.ui.v5.listeners.BannerInstructionsListener;
...
class NavigationViewEventDispatcher {
  ...
  /**
   * Initializes the listeners in the dispatcher, as well as the listeners in the {@link TrackAsiaNavigation}
   *
  ...
  void initializeListeners(NavigationViewOptions navigationViewOptions, NavigationViewModel navigationViewModel) {
    ...
    TrackAsiaNavigation navigation = navigationViewModel.retrieveNavigation();
  ...
  void onDestroy(@Nullable TrackAsiaNavigation navigation) {
    if (navigation != null) {
  ...
  private void assignProgressChangeListener(NavigationViewOptions navigationViewOptions, TrackAsiaNavigation navigation) {
  ...
  private void assignMilestoneEventListener(NavigationViewOptions navigationViewOptions, TrackAsiaNavigation navigation) {
  ...
  private void removeMilestoneEventListener(TrackAsiaNavigation navigation) {
    if (milestoneEventListener != null) {
      navigation.removeMilestoneEventListener(milestoneEventListener);
    }
  }

  private void removeProgressChangeListener(TrackAsiaNavigation navigation) {
    if (progressChangeListener != null) {
