...
import com.trackasia.turf.TurfConversion
...
class DistanceFormatter(
    ...
    language: String?,
    unitType: UnitType,
    private val roundingIncrement: TrackAsiaNavigationOptions.RoundingIncrement
) {
     ...
     */
    @Suppress("unused")
    fun shouldUpdate(language: String, unitType: UnitType, roundingIncrement: TrackAsiaNavigationOptions.RoundingIncrement): Boolean {
