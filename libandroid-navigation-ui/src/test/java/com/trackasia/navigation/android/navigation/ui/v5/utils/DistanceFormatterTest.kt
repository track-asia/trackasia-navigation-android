...
class DistanceFormatterTest {
    ...
    fun formatDistance_noLocaleCountry() {
        assertOutput(
            ...
            UnitType.IMPERIAL,
            TrackAsiaNavigationOptions.RoundingIncrement.ROUNDING_INCREMENT_FIFTY,
            "11 mi"
        )
    }
    ...
    fun formatDistance_smallFeet_roundToTen() {
        assertOutput(
            ...
            Locale.US,
            UnitType.IMPERIAL,
            TrackAsiaNavigationOptions.RoundingIncrement.ROUNDING_INCREMENT_TEN,
            "40 ft"
        )
    }
    ...
    private fun assertOutput(
        ...
        locale: Locale,
        unitType: UnitType,
        roundIncrement: TrackAsiaNavigationOptions.RoundingIncrement,
        output: String
    ) {
        Assert.assertEquals(
            output,
