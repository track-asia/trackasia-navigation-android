...
**BREAKING CHANGES:**
- Convert module `libandroid-navigation` to Kotlin. See description of PR [#127](https://github.com/track-asia/trackasia-navigation-android/pull/127) to get informed about all breaking changes
- Updated startNavigation() in NavigationLauncher to just use a context instead of an activity [#126](https://github.com/track-asia/trackasia-navigation-android/pull/126)

### v4.0.0 - November 9, 2024

**BREAKING CHANGES:**
- Update naming and packages to TrackAsia (`com.trackasia.navigation.android`)
- Update TrackAsia native to v11
...
- Added sample code on how to use the Valhalla routing server directly in `ValhallaNavigationActivity`. Please make sure to add this line to the `app/main/res/values/developer-config.xml`:
  ...
  ```
- Fix crash on ManeuverView, caused by `contains` not being able to handle null values [#122](https://github.com/track-asia/trackasia-navigation-android/issues/122)
