...
import com.trackasia.navigation.android.navigation.ui.v5.notification.service.NavigationNotificationService
import com.trackasia.navigation.android.navigation.ui.v5.notification.service.NavigationNotificationServiceConnection
 ...
 * 1. When [TrackAsiaNavigation] is ready, create instance of [NavigationNotificationServiceConnection]
...
class NavigationWithCustomForegroundNotificationActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    private fun startNavigationService(trackAsiaNavigation: TrackAsiaNavigation) {
        notificationServiceConnection = NavigationNotificationServiceConnection(trackAsiaNavigation, CustomNavigationNotification(this))
