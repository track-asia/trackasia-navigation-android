...
import TrackAsia
import TrackAsiaNavigationCore
import Alamofire
...
class CoreOnlyViewController: UIViewController, MLNMapViewDelegate, ProgressChangeListener {
    ...
    override func viewDidLoad() {
        ...
        mapView.styleURL = URL(
            string: "https://maps.track-asia.com/styles/v1/streets.json?key=public_key"
        )
    ...
    private func loadRoute(map: MLNMapView, style: MLNStyle) {
        ...
        fetchRoute { directionsRoute in
            ...
            //            let navigationOptions = TrackAsiaNavigationOptions()
            let mlNavigation = IOSTrackAsiaNavigation.Builder()
    ...
    private func drawRoute(style: MLNStyle, route: DirectionsRoute) {
        ...
        // TODO (fabi755): should be done by TrackAsia GeoJSON library
        // But before this is possible, we need to update the TrackAsia native iOS one to the new KMP library
    ...
    private func enableLocationComponent(map: MLNMapView, navigation: TrackAsiaNavigation) {
